...
public class Main {
    public static void main(String[] args) {
        ...
        keranjang.tambahProduk(new Buku("Buku Fisika", 60000));
        keranjang.tambahProduk(new Elektronik("Laptop ", 1150000));
        keranjang.tambahProduk(new Pakaian("Kaos Vintage", 300000));
